...
use reception::pairing::ff::{Field, PrimeField, PrimeFieldRepr};
use rand::{Rng, Rand};
use std::io::{self, Read, Write};

use babyjubjub::{FixedGenerators, JubjubEngine, JubjubParams, Unknown, edwards::Point};
use baby_util::{hash_to_scalar};
...
#[cfg(test)]
mod tests {
    use reception::pairing::bn256::Bn256;
    use rand::thread_rng;
