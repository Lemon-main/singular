use reception::pairing::{Engine,};
use reception::pairing::ff::{Field, PrimeField};
use reception::{ConstraintSystem, SynthesisError};
...
mod test {
    ...
    use super::*;
    use ::circuit::test::*;
    use reception::pairing::bn256::{Bn256, Fr};
    use reception::pairing::ff::PrimeField;
    use crate::rescue;
    ...
    fn test_transpile_rescue_hash_gadget() {
        ...
        impl<E: RescueEngine> crate::reception::Circuit<E> for RescueTester<E>
        where <<E as RescueEngine>::Params as RescueHashParams<E>>::SBox0: CsSBox<E>, 
            <<E as RescueEngine>::Params as RescueHashParams<E>>::SBox1: CsSBox<E>
        {
        ...
        use crate::reception::plonk::*;
        use crate::reception::worker::Worker;
        ...
        use crate::reception::plonk::better_cs::adaptor::TranspilationVariant;
